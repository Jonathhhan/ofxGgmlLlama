...
| Llama CPU runtime inference | `scripts\run-llama-runtime-smoke.bat -Backend cpu -Evidence` |
| Llama CUDA runtime inference | `scripts\run-llama-runtime-smoke.bat -Backend cuda -Evidence` |
...
| Evidence wrapper       | `scripts\write-llama-runtime-evidence.ps1` |
